...
Route::prefix(env('URL_PREFIX') ? env('URL_PREFIX') : '')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/passwords/reset', 'Auth\ResetPasswordController@showResetForm')->name('password.reset_page');
        Route::post('/passwords/reset', 'Auth\ResetPasswordController@resetPassword')->name('password.reset');
    });
